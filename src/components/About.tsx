      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-lg text-portfolio-gray leading-relaxed">
                  Hey! I'm Arka — a designer who loves turning real-world problems into simple, human-first solutions.
                </p>
                
                <p className="text-lg text-portfolio-gray leading-relaxed">
                  I mix structure with creativity and pixels with purpose. My approach combines user research, thoughtful design systems, and collaborative iteration to create interfaces that people actually want to use.
                </p>
              </div>
            </div>
            ...
            {/* Values */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-portfolio-dark">Core Values</h3>
              <div className="grid grid-cols-3 gap-4">
                {['Empathy', 'Function', 'Elegance'].map((value) => (
                  <div key={value} className="text-center">
                    ...
                    <span className="text-sm font-medium text-portfolio-dark">{value}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-portfolio-dark">Tools I Work With</h3>
                ...
                {tools.map((tool, index) => (
                  ...
                  >
                    <div className="flex flex-col items-center text-center space-y-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-portfolio-dark">{tool.name}</h4>
                        <p className="text-sm text-portfolio-gray mt-1">Design Tool</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-r from-portfolio-violet/5 to-portfolio-mint/5 rounded-2xl p-8">
              <div className="grid grid-cols-2 gap-8 text-center">
                <div>
                  <div className="text-3xl font-bold text-portfolio-violet">3+</div>
                  <div className="text-sm text-portfolio-gray">Years Experience</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-portfolio-mint">50+</div>
